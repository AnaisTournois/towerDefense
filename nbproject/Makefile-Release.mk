...
${OBJECTDIR}/BalleAttaque.o: BalleAttaque.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BalleAttaque.o BalleAttaque.cpp

${OBJECTDIR}/BalleRalentissante.o: BalleRalentissante.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BalleRalentissante.o BalleRalentissante.cpp
...
${OBJECTDIR}/Chemin.o: Chemin.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Chemin.o Chemin.cpp

${OBJECTDIR}/ElementCombattant.o: ElementCombattant.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ElementCombattant.o ElementCombattant.cpp

${OBJECTDIR}/ElementDynamique.o: ElementDynamique.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ElementDynamique.o ElementDynamique.cpp

${OBJECTDIR}/ElementVisuel.o: ElementVisuel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ElementVisuel.o ElementVisuel.cpp
...
${OBJECTDIR}/Monstre.o: Monstre.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Monstre.o Monstre.cpp
...
${OBJECTDIR}/TourAttaque.o: TourAttaque.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TourAttaque.o TourAttaque.cpp

${OBJECTDIR}/TourRalentissante.o: TourRalentissante.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/TourRalentissante.o TourRalentissante.cpp

${OBJECTDIR}/Vague.o: Vague.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Vague.o Vague.cpp

${OBJECTDIR}/Virage.o: Virage.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Virage.o Virage.cpp
